...
public class BaseClass {
	...
	public static  void takeSnap(String filename) throws IOException {
		...
		File dest = new File("C:\\Users\\Admin\\eclipse-workspace\\Cucumber\\Screenshot+ name "+".png");
	...
	public static String excelRead(int rowNo, int cellNo) throws IOException {
		...
		File file = new File("C:\\Users\\Admin\\eclipse-workspace\\JUnit\\datas\\Data1.xlsx");
